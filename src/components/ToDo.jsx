...
const ToDo = () => {
    ...
    const add = ()=>{
        ...
        const newTodo = {
            id: Date.now(),                                                     // to generate unique ids  
            text: inputText,
            isComplete: false
        }
...
{/* ---------------------------------------input-box--------------------------------------- */}
        <div className='flex items-center my-7 bg-gray-200 rounded-full'>
            ...
            <button onClick={add} className='border-none rounded-full bg-orange-500 w-32 h-14 text-white font-medium cursor-pointer'>ADD +</button>
        </div>
{/* ------------------------------------------todo-list-------------------------------------- */}
        <div>
